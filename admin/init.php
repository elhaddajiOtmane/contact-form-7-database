...
add_filter( 'plugin_action_links', 'wpcf7db_plugin_action_links', 10, 2 );
...
if ( ! function_exists( 'cf7d_register_custom_submenu_page' ) ) {
	function cf7d_register_custom_submenu_page() {
		$GLOBALS['njt_cf7d_hook_suffix'] = add_submenu_page( 'wpcf7', __( 'Database', 'cf7-database' ), __( 'Database', 'cf7-database' ), apply_filters( 'cf7d_options_page_capabilities', 'manage_options' ), 'cf7-data', 'cf7d_custom_submenu_page_callback' );
	}
}
